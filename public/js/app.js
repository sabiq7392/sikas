...
/***/ "./resources/js/components/min-max-sidebar.js":
/*!****************************************************!*\
  !*** ./resources/js/components/min-max-sidebar.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _max = /*#__PURE__*/new WeakSet();

var _storeDataToLocalStorage = /*#__PURE__*/new WeakSet();

var _deleteDataFromLocalStorage = /*#__PURE__*/new WeakSet();

var _getDataFromLocalStorage = /*#__PURE__*/new WeakSet();

var _changedStyleAllTriggeredElement = /*#__PURE__*/new WeakSet();

var MinMaxSidebar = /*#__PURE__*/function () {
  function MinMaxSidebar() {
    _classCallCheck(this, MinMaxSidebar);

    _classPrivateMethodInitSpec(this, _changedStyleAllTriggeredElement);

    _classPrivateMethodInitSpec(this, _getDataFromLocalStorage);

    _classPrivateMethodInitSpec(this, _deleteDataFromLocalStorage);

    _classPrivateMethodInitSpec(this, _storeDataToLocalStorage);

    _classPrivateMethodInitSpec(this, _max);
  ...
  _createClass(MinMaxSidebar, [{
    key: "render",
    value: function render() {
      if (this.button) {
        _classPrivateMethodGet(this, _getDataFromLocalStorage, _getDataFromLocalStorage2).call(this);
...
function _onClick2() {
  ...
  this.button.addEventListener('click', function () {
    if (_this.button.classList.contains('active')) {
      _classPrivateMethodGet(_this, _max, _max2).call(_this);
    } else {
      _classPrivateMethodGet(_this, _min, _min2).call(_this);
    }
  });
}
...
function _min2() {
  ...
  _classPrivateMethodGet(this, _changedStyleAllTriggeredElement, _changedStyleAllTriggeredElement2).call(this, {
    buttonStyle: 'active',
  ...
  _classPrivateMethodGet(this, _storeDataToLocalStorage, _storeDataToLocalStorage2).call(this, {
    button: button,
    sidebar: sidebar,
    main: main,
    brand: brand,
...
function _max2() {
  ...
  _classPrivateMethodGet(this, _deleteDataFromLocalStorage, _deleteDataFromLocalStorage2).call(this);
}

function _storeDataToLocalStorage2(_ref) {
...
function _deleteDataFromLocalStorage2() {
  localStorage.removeItem('min-max-sidebar');
}

function _getDataFromLocalStorage2() {
  var dataParsed = JSON.parse(localStorage.getItem('min-max-sidebar'));
...
function _changedStyleAllTriggeredElement2(_ref2) {
  var buttonStyle = _ref2.buttonStyle,
      sidebarStyle = _ref2.sidebarStyle,
      mainStyle = _ref2.mainStyle,
      navbarStyle = _ref2.navbarStyle,
      buttonAttributeValue = _ref2.buttonAttributeValue,
      brandStyle = _ref2.brandStyle;
  var sidebar = this.sidebar,
      button = this.button,
      main = this.main,
      brand = this.brand;
...
var minMaxSidebar = new MinMaxSidebar();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (minMaxSidebar);
...
/***/ "./resources/js/components/show-hide-password.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/show-hide-password.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ShowHidePassword = /*#__PURE__*/function () {
  function ShowHidePassword() {
    _classCallCheck(this, ShowHidePassword);
...
function _onClick2() {
  ...
  button.addEventListener('click', function () {
    if (button.classList.contains('active')) {
      _classPrivateMethodGet(_this, _hide, _hide2).call(_this, button, input);
    } else {
      _classPrivateMethodGet(_this, _show, _show2).call(_this, button, input);
    }
  });
}

function _show2(button, input) {
  button.classList.add('active');
  button.firstElementChild.className = 'bi bi-eye-slash';
  input.setAttribute('type', 'text');
}

function _hide2(button, input) {
  button.classList.remove('active');
  button.firstElementChild.className = 'bi bi-eye';
  input.setAttribute('type', 'password');
}

var showHidePassword = new ShowHidePassword();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showHidePassword);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksikas"] = self["webpackChunksikas"] || [];
